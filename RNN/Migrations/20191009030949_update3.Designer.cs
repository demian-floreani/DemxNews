...
namespace RNN.Migrations
{
    ...
    [Migration("20191009030949_update3")]
            ...
            modelBuilder.Entity("RNN.Models.Editorial", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AuthorId = 1, Body = "", Img = "editorial.jpg", IsFeatured = true, Paragraph = "Leadership campaign falters as he refuses to respond to questions at hustings about late-night argument with Carrie Symonds", Title = "Boris Johnson under fire over row with partner as top Tories raise fears", Url = "" }
                    );
                });
            ...
            modelBuilder.Entity("RNN.Models.OpinionToTopic", b =>
                {
                    ...
                    b.HasData(
                        new { TopicId = 30, OpinionId = 1 },
                        new { TopicId = 30, OpinionId = 2 },
                        new { TopicId = 30, OpinionId = 3 },
                        new { TopicId = 30, OpinionId = 4 },
                        new { TopicId = 2, OpinionId = 5 },
                        new { TopicId = 29, OpinionId = 6 },
                        new { TopicId = 5, OpinionId = 7 }
                    );
                });
            ...
            modelBuilder.Entity("RNN.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsFeatured = true, Title = "Journalists Detained During First Day of Bilderberg", Url = "" },
                        new { Id = 2, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsFeatured = true, Title = "RON PAUL: US/UK Trying To Kill Assange?", Url = "" },
                        new { Id = 3, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsFeatured = true, Title = "Merkel Attacks Trump in Harvard Speech", Url = "" },
                        new { Id = 4, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsFeatured = true, Title = "Bye-bye Bolton?", Url = "" },
                        new { Id = 5, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsFeatured = true, Title = "White House launches tool to report censorship on Facebook", Url = "" },
                        new { Id = 6, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsFeatured = true, Title = "Barr: Mueller could have reached a decision on obstruction", Url = "" },
                        new { Id = 7, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsFeatured = true, Title = "U.S. Economy Grew 3.1% in First Quarter", Url = "" },
                        new { Id = 8, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsFeatured = true, Title = "Donald Trump: 'I Got Me Elected'", Url = "" },
                        new { Id = 9, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsFeatured = true, Title = "Test post: put all the content here for the post title 1", Url = "" },
                        new { Id = 10, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsFeatured = true, Title = "Test post: put all the content here for the post title 2", Url = "" },
                        new { Id = 11, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsFeatured = true, Title = "Test post: put all the content here for the post title 3", Url = "" },
                        new { Id = 12, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsFeatured = true, Title = "Test post: put all the content here for the post title 4", Url = "" },
                        new { Id = 13, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsFeatured = true, Title = "Test post: put all the content here for the post title 5", Url = "" },
                        new { Id = 14, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsFeatured = true, Title = "Test post: put all the content here for the post title 6", Url = "" },
                        new { Id = 15, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsFeatured = true, Title = "Test post: put all the content here for the post title 7", Url = "" },
                        new { Id = 16, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsFeatured = true, Title = "Test post: put all the content here for the post title 8", Url = "" }
                    );
                });
