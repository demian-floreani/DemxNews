    ...
    public class Seed
    {
        ...
        public static void SeedDatabase(ModelBuilder modelBuilder)
        {
            List<Title> titles = new List<Title>() 
            {
                ...
                new Title() { Id = 8, Name = "EU Article" },
            ...
            List<Article> Articles = new List<Article>()
            {
                ...
                new Article()
                {
                    ...
                    Paragraph = "Leadership campaign falters as he refuses to respond to questions at hustings about late-night argument with Carrie Symonds",
                    Body = "",
                    HeadLine = "MPs debate Boris Johnson's deal as People's Vote march sets off – live Article",
                    GroupingId = 2,
                    Rank = 2,
                    Width = 8
                },
            ...
            Articles.ForEach(x => x.Id = i++);
            modelBuilder.Entity<Article>().HasData(Articles.ToArray());

            List<EntryToTopic> ArticleToTopics = new List<EntryToTopic>()
            {
                ...
                new EntryToTopic() { Entry = new Entry() { HeadLine = "MPs debate Boris Johnson's deal as People's Vote march sets off – live Article" }, Topic = new Topic() { Name = "Topic 2"} },
                new EntryToTopic() { Entry = new Entry() { HeadLine = "Article piece 1" }, Topic = new Topic() { Name = "Topic 1"} },
                new EntryToTopic() { Entry = new Entry() { HeadLine = "Article piece 1" }, Topic = new Topic() { Name = "Topic 2"} },
                new EntryToTopic() { Entry = new Entry() { HeadLine = "Article piece 2" }, Topic = new Topic() { Name = "Topic 3"} },
                new EntryToTopic() { Entry = new Entry() { HeadLine = "Article piece 3" }, Topic = new Topic() { Name = "Topic 4"} },
                new EntryToTopic() { Entry = new Entry() { HeadLine = "Article piece 4" }, Topic = new Topic() { Name = "Topic 5"} },
                new EntryToTopic() { Entry = new Entry() { HeadLine = "Article piece 5" }, Topic = new Topic() { Name = "Topic 6"} },
                new EntryToTopic() { Entry = new Entry() { HeadLine = "Article piece 6" }, Topic = new Topic() { Name = "Topic 7"} },
                new EntryToTopic() { Entry = new Entry() { HeadLine = "Article piece 7" }, Topic = new Topic() { Name = "Topic 1"} },
            ...
            foreach (var item in ArticleToTopics)
            {
                item.EntryId = Articles.FirstOrDefault(p => p.HeadLine == item.Entry.HeadLine).Id;
                item.TopicId = topics.FirstOrDefault(t => t.Name == item.Topic.Name).Id;
                item.Entry = null;
                item.Topic = null;
            }

            modelBuilder.Entity<EntryToTopic>().HasData(ArticleToTopics.ToArray());
        }
    }
}
