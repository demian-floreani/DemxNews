            ...
            modelBuilder.Entity("RNN.Models.ArticleToTopic", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { TopicId = 5, ArticleId = 6 },
                        new { TopicId = 29, ArticleId = 7 },
                        new { TopicId = 30, ArticleId = 8 },
                        new { TopicId = 31, ArticleId = 9 },
                        new { TopicId = 33, ArticleId = 10 },
                        new { TopicId = 2, ArticleId = 11 },
                        new { TopicId = 30, ArticleId = 12 },
                        new { TopicId = 30, ArticleId = 13 },
                        new { TopicId = 30, ArticleId = 14 },
                        new { TopicId = 8, ArticleId = 15 },
                        new { TopicId = 2, ArticleId = 16 },
                        new { TopicId = 30, ArticleId = 17 },
                        new { TopicId = 2, ArticleId = 17 },
                        new { TopicId = 30, ArticleId = 18 },
                        new { TopicId = 30, ArticleId = 19 },
                        new { TopicId = 30, ArticleId = 20 },
                        new { TopicId = 2, ArticleId = 21 },
                        new { TopicId = 29, ArticleId = 22 },
                        new { TopicId = 5, ArticleId = 23 }
                    );
                });
            ...
            modelBuilder.Entity("RNN.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 6, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), HeadLine = "Donald Trump: 'I Got Me Elected'", IsFeatured = true, Url = "" },
                        new { Id = 7, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), HeadLine = "Test post: put all the content here for the post title 1", IsFeatured = true, Url = "" },
                        new { Id = 8, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), HeadLine = "Test post: put all the content here for the post title 2", IsFeatured = true, Url = "" },
                        new { Id = 9, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), HeadLine = "Test post: put all the content here for the post title 3", IsFeatured = true, Url = "" },
                        new { Id = 10, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), HeadLine = "Test post: put all the content here for the post title 4", IsFeatured = true, Url = "" },
                        new { Id = 11, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), HeadLine = "Test post: put all the content here for the post title 5", IsFeatured = true, Url = "" },
                        new { Id = 12, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), HeadLine = "Test post: put all the content here for the post title 6", IsFeatured = true, Url = "" },
                        new { Id = 13, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), HeadLine = "Test post: put all the content here for the post title 7", IsFeatured = true, Url = "" },
                        new { Id = 14, Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), HeadLine = "Test post: put all the content here for the post title 8", IsFeatured = true, Url = "" }
                    );
                });
