...
namespace RNN.Controllers
{
    public class ArticlesController : Controller
    {
        ...
        public ArticlesController(RNNContext context)
        {
            _context = context;
        }
        ...
        {
            var rNNContext = _context.Articles.Include(a => a.Grouping).Include(a => a.Author).Include(a => a.Title);
        ...
        public async Task<IActionResult> Create([Bind("TitleId,Paragraph,Img,Body,AuthorId,Rank,Width,Id,HeadLine,Url,Date,GroupingId")] Article article)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TitleId,Paragraph,Img,Body,AuthorId,Rank,Width,Id,HeadLine,Url,Date,GroupingId")] Article article)
        {
            if (id != article.Id)
            {
                return NotFound();
